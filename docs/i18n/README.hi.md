...
`YOLFI_API_BASE_URL` और `YOLFI_PAY_BASE_URL` वैकल्पिक हैं, जब तक आपको किसी गैर-डिफ़ॉल्ट Yolfi वातावरण को लक्षित नहीं करना हो।
...
`yolfi-api` टूल Yolfi API को कॉल करते हैं और `YOLFI_API_KEY` मांगते हैं। `yolfi-knowledge` संसाधन कुंजी बनने से पहले एजेंट को एकीकरण का रास्ता समझने में मदद करते हैं।
...
| --- | --- | --- |
| Yolfi कार्यक्षेत्र पंजीकृत करें | `POST /api/auth/agent/register` | public |
